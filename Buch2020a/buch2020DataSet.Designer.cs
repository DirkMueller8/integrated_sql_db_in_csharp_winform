...
namespace Buch2020a {
    ...
    public partial class buch2020DataSet : global::System.Data.DataSet {
        ...
        public partial class KundeDataTable : global::System.Data.TypedTableBase<KundeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public KundeRow AddKundeRow(string kName, string vorname, string strasse, string postleitzahl, string ort, string telefon1) {
...
namespace Buch2020a.buch2020DataSetTableAdapters {
    ...
    public partial class KundeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Kunde] ([kName], [vorname], [strasse], [postleitzahl], [ort], [telefon1]) VALUES (@kName, @vorname, @strasse, @postleitzahl, @ort, @telefon1);
SELECT kNummer, kName, vorname, strasse, postleitzahl, ort, telefon1 FROM Kunde WHERE (kNummer = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Kunde] SET [kName] = @kName, [vorname] = @vorname, [strasse] = @strasse, [postleitzahl] = @postleitzahl, [ort] = @ort, [telefon1] = @telefon1 WHERE (([kNummer] = @Original_kNummer) AND ([kName] = @Original_kName) AND ([vorname] = @Original_vorname) AND ([strasse] = @Original_strasse) AND ([postleitzahl] = @Original_postleitzahl) AND ([ort] = @Original_ort) AND ((@IsNull_telefon1 = 1 AND [telefon1] IS NULL) OR ([telefon1] = @Original_telefon1)));
SELECT kNummer, kName, vorname, strasse, postleitzahl, ort, telefon1 FROM Kunde WHERE (kNummer = @kNummer)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Buch2020a.Properties.Settings.Default.buch2020ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT kNummer, kName, vorname, strasse, postleitzahl, ort, telefon1 FROM dbo.Kun" +
                "de";
        ...
        public virtual int Delete(int Original_kNummer, string Original_kName, string Original_vorname, string Original_strasse, string Original_postleitzahl, string Original_ort, string Original_telefon1) {
        ...
        public virtual int Insert(string kName, string vorname, string strasse, string postleitzahl, string ort, string telefon1) {
            if ((kName == null)) {
        ...
        public virtual int Update(string kName, string vorname, string strasse, string postleitzahl, string ort, string telefon1, int Original_kNummer, string Original_kName, string Original_vorname, string Original_strasse, string Original_postleitzahl, string Original_ort, string Original_telefon1, int kNummer) {
            if ((kName == null)) {
                throw new global::System.ArgumentNullException("kName");
            }
            else {
            ...
            if ((Original_strasse == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_strasse));
            }
            if ((Original_postleitzahl == null)) {
                throw new global::System.ArgumentNullException("Original_postleitzahl");
            }
            ...
            if ((Original_telefon1 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_telefon1));
            }
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(kNummer));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string kName, string vorname, string strasse, string postleitzahl, string ort, string telefon1, int Original_kNummer, string Original_kName, string Original_vorname, string Original_strasse, string Original_postleitzahl, string Original_ort, string Original_telefon1) {
            return this.Update(kName, vorname, strasse, postleitzahl, ort, telefon1, Original_kNummer, Original_kName, Original_vorname, Original_strasse, Original_postleitzahl, Original_ort, Original_telefon1, Original_kNummer);
        }
    }
